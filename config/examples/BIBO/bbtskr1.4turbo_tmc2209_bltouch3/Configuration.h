 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 48, 46, -2.9 }
...
#define X_MIN_POS -107    // - X BED Size 214/2, ther are no obstacles here so it can be the actual min value
#define Y_MIN_POS -85     // Additional fan scrapes the front cover, reducing to accmodate
#define Z_MIN_POS 0
#define X_MAX_POS 145     // Add Home Position Offset)
#define Y_MAX_POS 88      // Subtract Home Position Offset)
